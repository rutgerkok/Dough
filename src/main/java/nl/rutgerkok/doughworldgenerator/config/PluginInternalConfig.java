...
public class PluginInternalConfig {
    ...
    public void update(RawConfig config) throws InvalidConfigException {
        ...
        this.cacheKey = config.getString("cache_key", cacheKey,
                "The cache key representing the current world generation settings and Minecraft version. Used to determine whether the datapack needs to be regenerated.");
    }
}
